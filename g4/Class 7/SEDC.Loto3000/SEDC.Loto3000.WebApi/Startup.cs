...
namespace SEDC.Loto3000.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<JwtSettings>(jwtSettingsSection);//IOptions could use it
            //services.AddSingleton(jwtSettings); so we can ask for JwtSettings istance in the constructors
